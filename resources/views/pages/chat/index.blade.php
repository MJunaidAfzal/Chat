                    ...
                    <ul class="nav nav-pills side-menu-nav" role="tablist">
                        ...
                        <li class="nav-item dropdown profile-user-dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="{{asset('assets/images/users/avatar-1.jpg')}}" alt="" class="profile-user rounded-circle">
                            </a>
                        ...
                        <div>
                            ...
                            <div class="text-center p-3 p-lg-4 border-bottom pt-2 pt-lg-2 mt-n5 position-relative">
                                <div class="mb-lg-3 mb-2">
                                    <img src="{{asset('assets/images/users/avatar-1.jpg')}}" class="rounded-circle avatar-lg img-thumbnail" alt="">
                                </div>
                        ...
                        <div>
                            ...
                            <div class="text-center p-3 p-lg-4 border-bottom pt-2 pt-lg-2 mt-n5 position-relative">
                                <div class="mb-3 profile-user">
                                    <img src="{{asset('assets/images/users/avatar-1.jpg')}}" class="rounded-circle avatar-lg img-thumbnail user-profile-image" alt="user-profile-image">
                ...
                <div class="chat-content d-lg-flex">
                                        ...
                                        <div class="flex-grow-1 overflow-hidden">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0 chat-user-img online user-own-img align-self-center me-3">
                                                    <img src="{{asset('assets/images/users/user-dummy-img.jpg')}}" class="rounded-circle avatar-sm" alt="">
                                                </div>
                                                <div class="flex-grow-1 overflow-hidden">
                    ...
                    <div class="user-profile-sidebar">
                        ...
                        <div class="p-3 border-bottom">
                            <div class="user-profile-img">
                                <img src="{{asset('assets/images/users/avatar-2.jpg')}}" class="profile-img rounded" alt="">
                        ...
                        <div class="p-4 user-profile-desc" data-simplebar>
                            ...
                            <div>
                                ...
                                <div class="profile-media-img">
                                    ...
                                    <div class="media-img-list">
                                        <a href="#">
                                            <img src="{{asset('assets/images/small/img-3.jpg')}}" alt="media img" class="img-fluid">
                                        </a>
                                    </div>
                                    <div class="media-img-list">
                                        <a href="#">
